...
public class CollectionTester {
	...
	private static double[] checkPerformance(Collection<Integer> col, int DIM) {
		...
		add = (stop - start) / 1e6; // converter para milisegundos
		...
		stop = System.nanoTime(); // clock snapshot after
		search = (stop - start) / 1e6; // converter para milisegundos
		...
		stop = System.nanoTime(); // clock snapshot after
		remove = (stop - start) / 1e6; // converter nanosegundos para milisegundos
