...
load chaves1b.mat; % Carregar o conjunto de chaves do exercício 1b
...
for idxTipo = 1:length(tiposHash)
    ...
    for idxTamanho = 1:length(tamanhosHashTables)
        ...
        [numColisoes, maxAtribuicoes, tempoExecucao, momentos, hashCodes] = simularHashTable(chaves1b, tipoHash, tamanho);
